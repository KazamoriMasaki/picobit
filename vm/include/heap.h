...
#define MIN_RAM_ENCODING (MAX_RAM_ENCODING - (ARCH_RAM_BYTES / 4) + 1)
#define MAX_RAM_ENCODING 8191

#define MIN_ROM_ENCODING (MIN_FIXNUM_ENCODING + MAX_FIXNUM - MIN_FIXNUM + 1)

#if (MIN_ROM_ENCODING - MIN_RAM_ENCODING + 1) > (ARCH_ROM_BYTES / 4)
#define MAX_ROM_ENCODING (MIN_ROM_ENCODING + (ARCH_ROM_BYTES / 4) + 1)
#else
#define MAX_ROM_ENCODING (MIN_RAM_ENCODING - 1)
#endif

#define ROM_BYTES ((MAX_ROM_ENCODING - MIN_ROM_ENCODING + 1) * 4)

#define MIN_VEC_ENCODING MIN_RAM_ENCODING
#define MAX_VEC_ENCODING MAX_ROM_ENCODING
